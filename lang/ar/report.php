...
return [
    ...
    "media_mimes" =>
        "نوع الملف غير مدعوم. الأنواع المدعومة: صور (jpeg, jpg, png, gif), فيديو (mp4, mov, avi), صوت (mp3, wav, m4a)",
    "media_max" => "حجم الملف يجب ألا يتجاوز 50 ميجابايت",

    // Fallback safety advice
    "fallback_title" => "تعليمات السلامة غير متوفرة",
    "fallback_step_1" => "انتقل إلى مكان آمن فوراً.",
    "fallback_step_2" => "اتصل بخدمات الطوارئ المحلية.",
    "fallback_step_3" => "اتبع تعليمات السلطات المختصة.",
];
